...
@synthesize startPointOverride = _startPointOverride;
...
- (id)initWithFrame:(CGRect)frame menus:(NSArray *)aMenusArray startPoint:(CGPoint)where
{
    ...
    if (self) {
        ...
        self.startPoint = where;
		
        /*if ( self.startPointOverride)
            self.startPoint =self.startPointOverride;
        else
        ...
        _addButton.center = self.startPoint;// CGPointMake(30,30); //CGPointMake(kQuadCurveMenuDefaultStartPointX, kQuadCurveMenuDefaultStartPointY);
